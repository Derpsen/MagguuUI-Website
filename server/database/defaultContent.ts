export const DEFAULT_HOME_CONTENT = [
  ...
  { page: 'home', section: 'features', key: 'feature_2_text', value: 'Ellesmere-Profil <strong>MagguuUI</strong> mit Scale <strong>0.58</strong> und festem Tooltip. Klassen-Layouts als <strong>Magguu - Class Spec</strong>. Optionale Magguu-Profile für BigWigs, Northern Sky, EXBoss, WIM, Waypoint UI, HandyNotes, Talent Tree Tweaks, GTFO, BugSack, Premade Groups Filter und Smart Reminders.', type: 'html', sortOrder: 4, locale: 'de' },
  ...
  { page: 'home', section: 'addons', key: 'subtitle', value: 'EllesmereUI ist erforderlich. BigWigs, Northern Sky, EXBoss, WIM, Waypoint UI, HandyNotes, Talent Tree Tweaks, GTFO, BugSack, Premade Groups Filter und Smart Reminders sind optional.', type: 'text', sortOrder: 1, locale: 'de' },
] as const
...
- **Optional pack** — BugGrabber, BugSack, HandyNotes, HandyNotes MapNotes, MDT, Raider.IO, Simulationcraft, Talent Tree Tweaks, WIM, Ellesmere WIM Skin, Waypoint UI, GTFO, Premade Groups Filter, Auctionator, and Smart Reminders
