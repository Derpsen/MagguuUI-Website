...
- MagguuUI public copy (home/guide/FAQ/changelog/addon metadata) must stay
  ...
  (2026-09-11 includes dump addons + Smart Reminders), Magguu Settings overlay does not reimport
  ...
  BigWigs, Northern Sky, EXBoss, Smart Reminders. Skinning NAMES & COLORS DualRow (unit-frame | party/raid; class
