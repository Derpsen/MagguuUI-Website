export const DEFAULT_HOME_CONTENT = [
  ...
  { page: 'home', section: 'features', key: 'feature_2_text', value: 'Ellesmere-Profil <strong>MagguuUI</strong> mit Scale <strong>0.58</strong> und festem Tooltip. Klassen-Layouts als <strong>Magguu - Class Spec</strong>. Optionale Magguu-Profile für BigWigs, Northern Sky, EXBoss, WIM, Waypoint UI, HandyNotes, Talent Tree Tweaks, GTFO, BugSack und Premade Groups Filter.', type: 'html', sortOrder: 4, locale: 'de' },
  ...
  { page: 'home', section: 'features', key: 'feature_3_text', value: 'Skinning ist eine Kategorie <strong>NAMEN &amp; FARBEN</strong> (zwei Spalten): geteilte Unit-Frame-Namen, Party-/Raid-Namen und klassenfarbige Keybind-Modifier (AuraBuff-Zähler zentriert). QoL: Death Release, Co-Tank, Stealth/Stance, Spell Alerts, Itemlevel in Party und Raid (2P/4P), <strong>Smart Tab</strong>, Hide Services auf General (secret-safe), <strong>Quick Focus</strong>, ein <strong>Audio-Geräte-Umschalter</strong> am Ellesmere-Lautsprecher, <strong>Boiling Point</strong> und <strong>Targeted Spell Bars</strong> über Ellesmere (EXBoss MythicCast aus).', type: 'html', sortOrder: 7, locale: 'de' },
  ...
  { page: 'home', section: 'addons', key: 'subtitle', value: 'EllesmereUI ist erforderlich. BigWigs, Northern Sky, EXBoss, WIM, Waypoint UI, HandyNotes, Talent Tree Tweaks, GTFO, BugSack und Premade Groups Filter sind optional.', type: 'text', sortOrder: 1, locale: 'de' },
] as const
...
4. Log in, type \`/mui\`, and run **Apply Magguu profiles** on Setup (bake + Magguu Settings + companions). Use **Magguu Settings** (overlay/QoL only) and **Load profiles** (activate only) side by side, and copy WowUp packs from the same tab
...
There is no minimap button and no separate Magguu installer window.`,
  ...
  },
  {
    ...
    answer: `Ellesmere profiles are account-wide, so the MagguuUI profile is already there after the first Apply Magguu profiles.
...
It will not load unless EllesmereUI is installed **and enabled**.`,
  ...
  {
    category: 'addons',
    question: 'What does Apply Magguu profiles configure?',
    answer: `In order:
...
- **Optional pack** — BugGrabber, BugSack, HandyNotes, MDT, Raider.IO, Simulationcraft, Talent Tree Tweaks, WIM, Ellesmere WIM Skin, Waypoint UI, GTFO, Premade Groups Filter, Auctionator, and Smart Reminders
...
- Boiling Point (Blood Death Knight echo bar)
...
You can still change scale later in EllesmereUI; MagguuUI will not keep rewriting it unless you run Apply Magguu profiles again.`,
...

  {
    ...
    question: "Apply Magguu profiles didn't do anything",
    answer: `Check these:
...
Re-open Setup with \`/mui\` and run **Apply Magguu profiles** again.`,
    sortOrder: 0,
  },
  {
    category: 'troubleshooting',
