...
const form = reactive({
  ...
  addons: {
    ...
    subtitle: "EllesmereUI is required. BigWigs and Northern Sky Raid Tools are optional.",
  } as Record<string, string>,
  features_heading: {
    title: "Why MagguuUI?",
  ...
  features: {
    ...
    feature_1_text: "One sidebar row with Setup, Skinning, and QoL. Full 4K install, individual profiles, presets, and Edit Mode copy sit on Setup.",
    feature_2_emoji: "B",
