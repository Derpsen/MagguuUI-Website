...
export const ADDON_DEFAULTS: AddonDefault[] = [
  ...
  },
  {
    ...
    category: 'optional',
    emoji: '💬',
    description: 'Optional Magguu dump. Apply Magguu profiles and Load profiles apply Magguu WIM settings when WIM is installed (no Setup button).',
    sortOrder: 2,
  },
  {
    slug: 'waypointui',
    ...
    category: 'optional',
    emoji: '📍',
    description: 'Optional Magguu dump. Apply Magguu profiles and Load profiles apply Magguu Waypoint UI settings when the addon is installed (no Setup button).',
    sortOrder: 3,
  },
  {
    slug: 'exboss',
  ...
  },
  {
    ...
    category: 'optional',
    emoji: '📌',
    description: 'Optional Magguu dump. Apply Magguu profiles and Load profiles apply Magguu HandyNotes settings when the addon is installed (no Setup button).',
    url: `${CF}/handynotes`,
    sortOrder: 6,
  },
  {
    ...
    category: 'optional',
    emoji: '🌳',
    description: 'Optional Magguu dump. Apply Magguu profiles and Load profiles apply Magguu Talent Tree Tweaks settings when the addon is installed (no Setup button).',
  ...
  },
  {
    ...
    category: 'optional',
    emoji: '⚠️',
    description: 'Optional Magguu dump. Apply Magguu profiles and Load profiles apply Magguu GTFO settings when the addon is installed (no Setup button).',
    url: `${CF}/gtfo`,
    sortOrder: 8,
  },
  {
    ...
    category: 'optional',
    emoji: '🐛',
    description: 'Optional Magguu dump. Apply Magguu profiles and Load profiles apply Magguu BugSack settings when the addon is installed (no Setup button).',
    url: `${CF}/bugsack`,
    sortOrder: 9,
  },
  {
    ...
    category: 'optional',
    emoji: '🔍',
    description: 'Optional Magguu dump. Apply Magguu profiles and Load profiles apply Magguu Premade Groups Filter settings when the addon is installed (no Setup button).',
