...
export const ADDON_DEFAULTS: AddonDefault[] = [
  ...
  },
  {
    ...
    category: 'optional',
    emoji: '📣',
    description: 'Optional Magguu import and WowUp starter pack. Import writes Magguu appearance and author configs; import again replaces those Magguu configs.',
    url: `${CF}/exboss`,
    sortOrder: 4,
  },
  {
  ...
  },
  {
    ...
    category: 'optional',
    emoji: '💎',
    description: 'Optional Magguu import and WowUp optional pack. Setup imports Best in Slot for your current class, including Devourer, and overwrites current KeystoneLoot favorites.',
    url: `${CF}/keystoneloot`,
    sortOrder: 6,
  },
]
