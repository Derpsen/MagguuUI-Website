...
- **Setup → Optional** and **Load profiles** import KeystoneLoot Best in Slot for your current class, including **Devourer**. Dual ring/trinket slots plus extra dungeon jewelry; raid Archon Mythic All Bosses merge when the item is new. No MagguuKSL addon.
...
- Gold Setup is **Apply Magguu profiles**. Below it: **Apply Magguu Settings** and **Load profiles**. Scale \`0.58\` comes from those two. No Set-scale-only.
...
- **Apply Magguu profiles** is the gold button. Below: **Apply Magguu Settings** and **Load profiles** side by side.
...
- UI scale \`0.58\` is applied by **Apply Magguu profiles** and **Apply Magguu Settings**.
