...
- Magguu no longer includes KeystoneLoot BiS or WowUp optional KeystoneLoot.
...
- Bundled Magguu profiles recaptured from Magguu Tools (Ellesmere 9.0.8; Northern Sky and EXBoss).
...
- **Apply Magguu profiles**, **Load profiles**, and **Magguu Settings** apply Magguu chat channels and size (Services off General).

### Bugfixes

- Ellesmere Magguu import pre-checks **Window & Tooltip Skins**.
- Magguu no longer ships KeystoneLoot BiS import or optional pack membership.
